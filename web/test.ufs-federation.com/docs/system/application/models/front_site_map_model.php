<?php
class front_site_map_model extends Model{

	function front_site_map_model()
	{
		parent::Model();
    ...
    function view()
    {  
        $this->data['body_css_class']='inner content-right-sidebar site-map';


        $sql=$this->db->query('select * from `pages` 
                               where `sub_page_type`="site_map" 
