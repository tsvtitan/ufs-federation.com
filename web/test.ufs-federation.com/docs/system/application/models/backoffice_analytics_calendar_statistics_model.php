<?php
class backoffice_analytics_calendar_statistics_model extends Model{

	function backoffice_analytics_calendar_statistics_model()
	{
		parent::Model();
    ...
    { 
      $content['data']='';
        ...
        {
            $where.=' and `t`.`country` like "%'.$_SESSION['search'].'%"';
        }
