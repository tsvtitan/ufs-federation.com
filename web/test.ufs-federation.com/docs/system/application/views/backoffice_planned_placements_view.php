...
<!--                     <li><a href="<? echo($this->phpself.$this->page_name); ?>/import_xls"><? echo($this->lang->line('admin_tpl_import_xls')); ?></a></li>  -->
	...
	<td valign="top" align="center">
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="form_content">
          <? if($data){ ?>
		  <tr>
            <td class="header_title"><h5><? echo($this->lang->line('admin_planned_placement_name')); ?></h5></td>
		    <td class="header_title"><h5><? echo($this->lang->line('admin_planned_placement_sector')); ?></h5></td>
            <td class="header_title"><h5><? echo($this->lang->line('admin_planned_placement_placement')); ?></h5></td>
            <td class="header_title center"><h5><? echo($this->lang->line('admin_planned_placement_volume')); ?></h5></td>            
          ...
          <tr<? echo($item->css_class); ?>>
            ...
            <td class="item center"><? echo($item->placement); ?></td>
