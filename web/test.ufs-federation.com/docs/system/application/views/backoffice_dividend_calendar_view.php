  ...
  <tr>
	...
	<td valign="top" align="center">
      ...
      <? if($data){ ?>
        ...
        <td class="header_title center"><h5><? echo($this->lang->line('admin_dividend_sector')); ?></h5></td>
        <td class="header_title center"><h5><? echo($this->lang->line('admin_dividend_type')); ?></h5></td>            
        <td class="header_title center"><h5><? echo($this->lang->line('admin_dividends')); ?></h5></td>            
        <td class="header_title center"><h5><? echo($this->lang->line('admin_dividend_yield')); ?></h5></td>            
        <td class="header_title center"><h5><? echo($this->lang->line('admin_dividend_close_date')); ?></h5></td>            
        <td class="header_title center"><h5><? echo($this->lang->line('admin_dividend_price')); ?></h5></td>
        <td class="header_title center"></td>
          ...
          <tr<? echo($item->css_class); ?>>
            ...
            <td class="item center"><? echo($item->sector); ?></td>
            <td class="item center"><? echo($item->dividend_type); ?></td>            
            <td class="item center"><? echo($item->dividends); ?></td>            
            <td class="item center"><? echo($item->dividend_yield); ?> </td>            
            <td class="item center"><? echo(!is_null($item->close_date)?date('d.m.Y',strtotime($item->close_date)):''); ?></td>
