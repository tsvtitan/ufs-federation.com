	...
	<td valign="top" align="center">
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="form_content">
		  ...
		  <tr>
            ...
            <td class="header_title center"><h5><? echo($this->lang->line('admin_analytics_calendar_month')); ?></h5></td>
            <td class="header_title center"><h5><? echo($this->lang->line('admin_analytics_calendar_rate')); ?></h5></td>
            <td class="header_title center"><h5><? echo($this->lang->line('admin_analytics_calendar_forecast')); ?></h5></td>
            <td class="header_title center"><h5><? echo($this->lang->line('admin_analytics_calendar_previous_value')); ?></h5></td>
            <td class="header_title center"><h5><? echo($this->lang->line('admin_analytics_calendar_influence_factor')); ?></h5></td>
          ...
          <tr<? echo($item->css_class); ?>>
            ...
            <td class="item center"><? echo($item->month); ?></td>
            <td class="item center"><? echo($item->rate); ?></td>
            <td class="item center"><? echo($item->forecast); ?></td>
            <td class="item center"><? echo($item->previous_value); ?></td>
            <td class="item center"><? echo($item->influence_factor); ?></td>
			<td class="item">
