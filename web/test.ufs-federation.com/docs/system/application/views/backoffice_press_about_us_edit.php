  ...
  <tr>
    ...
    <form action="<? echo($this->uri->uri_string); ?>" method="post" onsubmit="return Valid_Form();" enctype="multipart/form-data">
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="form_content edit">
          ...
          <tr>
			<td class="header_title"><h5><? echo($this->lang->line('admin_tpl_article_name')); ?></h5></td>
		  </tr>
		  <tr>
		  	<td class="item"><input type="text" id="input_title" name="text[name]" value="<? echo(isset($data->name)?$data->name:''); ?>" class="text" /></td>
		  </tr>
          <tr>
			<td class="header_title"><h5><? echo($this->lang->line('admin_tpl_publisher_name')); ?></h5></td>
		  </tr>
		  <tr>
		  	<td class="item"><input type="text" name="text[publisher_name]" value="<? echo(isset($data->publisher_name)?$data->publisher_name:''); ?>" class="text" /></td>
		  </tr>
          <tr>
			<td class="header_title"><h5><? echo($this->lang->line('admin_tpl_logo')); ?></h5></td>
		  </tr>
		  <tr>
		  	<td class="item">
                <table cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    ...
                    <td class="item">	
                        <? if(isset($data->img)){ ?>
                            <? if(!empty($data->img)){ ?>
                              <img src="/upload/press_about_us/small/<? echo($data->img); ?>">
                            <? } ?>
