  ...
  <tr>
	...
	<form action="<? echo($this->uri->uri_string); ?>" method="post">
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="form_content">
		  ...
		  <tr>
		  	<td class="item"><input type="text" name="text[role]" value="<? echo(isset($data->role)?$data->role:''); ?>" class="text" /></td>
		  </tr>
		  <tr>
			<td class="header_title"><h5><? echo($this->lang->line('admin_tpl_description')); ?></h5></td>
		  </tr>
		  <tr>
		  	<td class="item"><textarea class="textarea" style="height: 50px;" name="text[description]"><? echo(isset($data->description)?$data->description:''); ?></textarea></td>
		  </tr>
		  <tr>
