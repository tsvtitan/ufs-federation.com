...
<head>
  ...
  <link rel="stylesheet" href="<? echo($this->base_url); ?>/css/main.css" media="screen,projection" title="screenview" />
...
<body class="<? echo($body_css_class); ?>" id="ufs-investment-company">
  <div id="wrapper">
	<div id="header">
		 <h1 id="logo">UFS Investment Company <a href="<? echo($this->base_url); ?>/">(на главную)</a></h1>
        <? echo($body_header); ?>
    </div>
