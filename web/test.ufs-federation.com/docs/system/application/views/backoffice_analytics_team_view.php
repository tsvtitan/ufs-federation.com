	...
	<td valign="top" align="center">
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="form_content">
          ...
          <tr<? echo($item->css_class); ?>>
            ...
            <td class="item"><? echo($item->display); ?></td>
			<td class="item">
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <? }else{ ?>	
                            <a href="<? echo($this->phpself.$this->page_name.'/sort/down/'.$item->id.'/'.$item->sort_id); ?>" title="<? echo($this->lang->line('admin_tpl_down')); ?>"><img src="/images/arrow_down.gif" alt="<? echo($this->lang->line('admin_tpl_down')); ?>" width="12" height="16" /></a>
                        <? } ?>
                        </td>
                        <td class="item_sort">
                        <? if($item->first_el==1){ ?>
                            <img src="/images/empty.gif" alt="" width="12" height="16" />
                        <? }else{ ?>
                            <a href="<? echo($this->phpself.$this->page_name.'/sort/up/'.$item->id.'/'.$item->sort_id); ?>" title="<? echo($this->lang->line('admin_tpl_up')); ?>"><img src="/images/arrow_up.gif" alt="<? echo($this->lang->line('admin_tpl_up')); ?>" width="12" height="16" /></a>
                        <? } ?>
                        </td>
