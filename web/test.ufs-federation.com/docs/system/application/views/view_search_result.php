...
<div class="page-content editor-content':''); ?>">
  <div class="search_blok">  
      <form method="POST" id="search_form" action="<? echo($this->phpself.'search.html'); ?>">
        ...
        <input type="text" value="<?echo($search_word)?>" name="text" id="text" placeholder="<? echo(dictionary('Поиск по сайту')); ?>"  />
 ...
 <p><? echo(dictionary('Вы искали')); ?> <strong>«<?echo($search_word)?>»</strong></p>  
     ...
     <h2><? echo(dictionary('Не нашли то, что искали? Позвоните нам')); ?> <nobr>+7 (495) 781-73-00</nobr></h2> 
