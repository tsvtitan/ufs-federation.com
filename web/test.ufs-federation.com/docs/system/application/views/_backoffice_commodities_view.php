	...
	<td valign="top" align="center">
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="form_content">
		  ...
		  <tr>
            ...
            <td class="header_title center"><h5><? echo($this->lang->line('admin_commodity_sector')); ?></h5></td>            
            <td class="header_title center"><h5><? echo($this->lang->line('admin_commodity_price_current')); ?></h5></td>            
            <td class="header_title center"><h5><? echo($this->lang->line('admin_commodity_price_fair')); ?></h5></td>            
            <td class="header_title center"><h5><? echo($this->lang->line('admin_commodity_potential')); ?></h5></td>            
            <td class="header_title center"><h5><? echo($this->lang->line('admin_commodity_recommendation')); ?></h5></td>
          ...
          <tr<? echo($item->css_class); ?>>
            ...
            <td class="item center"><? echo($item->potential); ?> %</td>            
