  ...
  <tr>
	...
	<form action="<? echo($this->uri->uri_string); ?>" method="post" onsubmit="return Valid_Form();">
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="form_content edit">
          ...
          <tr>
			<td class="header_title"><h5><? echo($this->lang->line('admin_issuers_debt_market_price_currency')); ?></h5></td>
		  </tr>
          <tr>
          ...
          <tr>
			<td class="header_title"><h5><? echo($this->lang->line('admin_issuers_debt_market_potential')); ?>,%</h5></td>
		  </tr>
		  <tr>
            <td class="item"><input type="text" name="text[potential]" value="<? echo(isset($data->potential)?$data->potential:'0'); ?>" class="text int" maxlength="10" /></td>
		  </tr>
