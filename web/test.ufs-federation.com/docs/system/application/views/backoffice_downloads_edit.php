		...
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="form_content edit">
		  ...
		  <tr>
		  	<td class="item">
                ...
                <? foreach($menu as $val){ ?>
                  <option <? echo(($val->sel!='')?$val->sel:''); ?> value="<? echo($val->id); ?>"><? echo($val->name); ?></option>                
                <? } ?>
				</select>
			</td>
		  </tr>
		  ...
		  <tr>
		  	<td class="item">
                ...
                <? if(isset($data->_file)){ ?>
                 <? if(!empty($data->_file)){ ?> 
                    - <a href="<? echo($this->base_url.'download-files/'.$data->url.$this->mail_urlsufix); ?>" target="_blank"><? echo($this->lang->line('admin_tpl_download')); ?></a>
                 <? } ?>
