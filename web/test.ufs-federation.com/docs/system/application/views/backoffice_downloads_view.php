          ...
          <tr>
            <td class="item">
                <ul class="sub_menu">
                    ...
                    <li><a href="javascript:void(0)"  onclick="javascript:window.open('<? echo($this->phpself); ?>popup/downloads_menu','popup','width=550,height=600,left=50,top=50,scrollbars=yes');"><? echo($this->lang->line('admin_pages_cat_editor')); ?></a></li>
                </ul>
            </td>
          </tr>
          <tr>
