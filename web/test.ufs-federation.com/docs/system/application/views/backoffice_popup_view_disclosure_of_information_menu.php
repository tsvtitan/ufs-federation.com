				...
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>					
						...
						<? if($item->parent_id==0){ ?>						
							...
							<? }else{ ?>	
								<a href="<? echo($this->phpself.$this->page_name.'/'.$this->uri->segment(3).'/sort/down/'.$item->id.'/'.$item->sort_id.'/'.$item->parent_id); ?>" title="<? echo($this->lang->line('admin_tpl_down')); ?>"><img src="/images/arrow_down.gif" alt="<? echo($this->lang->line('admin_tpl_down')); ?>" width="12" height="16" /></a>
							<? } ?>
							</td>
							<td class="item_sort">
							<? if($item->first_el==1){ ?>
								<img src="/images/empty.gif" alt="" width="12" height="16" />
							<? }else{ ?>
								<a href="<? echo($this->phpself.$this->page_name.'/'.$this->uri->segment(3).'/sort/up/'.$item->id.'/'.$item->sort_id.'/'.$item->parent_id); ?>" title="<? echo($this->lang->line('admin_tpl_up')); ?>"><img src="/images/arrow_up.gif" alt="<? echo($this->lang->line('admin_tpl_up')); ?>" width="12" height="16" /></a>
							<? } ?>
							</td>
