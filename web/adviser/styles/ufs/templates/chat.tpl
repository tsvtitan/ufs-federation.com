    ...
    <td colspan="2" height="100" valign="top" class="bgrn">
		...
		<tr>
			...
			<td align="right" valign="top" id="banner_orange">
				...
				<tr>
					<td height="25" align="right" valign="top" style="padding:5px">
				...
				<tr>
					<td nowrap="nowrap" style="padding-right:10px" align="right">
					<table width="150px" cellspacing="0" cellpadding="0" border="0">
						<tr align="center">
							<td><span style="font-size:16px;font-weight:bold;color:#525252">${msg:presurvey.title}</span></td>
						</tr>	
					</table>
					</td>
				</tr>
...
${endif:sslLink}
			...
			<td align="right" style="padding-right:17px;">
				...
				<td>
					<table cellspacing="0" cellpadding="0" border="0">
					<tr>
					<td width="200" height="18" bgcolor="#D09221" align="center" class="www"><a href="${msg:site.url}" title="${msg:company.title}" target="_blank">${msg:site.title}</a></td>
					</tr>
					</table>
				</td>
				<td width="5"></td>
