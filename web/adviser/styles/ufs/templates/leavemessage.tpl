...
${endif:errors}
		<center><table cellspacing="1" cellpadding="5" border="0" class="form">
			<tr>
			...
			<tr>
				...
				<td valign="top">
					<textarea name="message" tabindex="0" cols="33" rows="5" style="border:1px solid #878787; overflow:auto">${form:message}</textarea>
				</td>
			</tr>
${if:showcaptcha}
			<tr>
