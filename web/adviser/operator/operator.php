...
if (isset($_POST['login']) && isset($_POST['password'])) {
  ...
  $sex = getparam('sex');
	...
	if (count($errors) == 0) {
      ...
      // by TSV
      $newop = create_operator($login, $email, $phone, $occupation, $sex, $jabber, $password, $localname, $commonname, $jabbernotify ? 1 : 0, "");
      ...
      // by TSV
      update_operator($opId, $login, $email, $phone, $occupation, $sex, $jabber, $password, $localname, $commonname, $jabbernotify ? 1 : 0);
    ...
    // by TSV
    $page['formphone'] = topage($phone);
    $page['formoccupation'] = topage($occupation);
    $page['formsex'] = topage($sex);
    ...
    // by TSV
    $page['formphone'] = topage($op['vcphone']);
    $page['formoccupation'] = topage($op['vcoccupation']);
    $page['formsex'] = topage($op['vcsex']);
