...
//define('MAILINGS_HOST_PORT','app334234:1338');
define('MAILINGS_URL',sprintf('http://%s/service/api/mailings',MAILINGS_HOST_PORT));
define('MAILINGS_SEND_URL',sprintf('http://%s/service/api/mailings/send',MAILINGS_HOST_PORT));
define('MAILINGS_CANCEL_URL',sprintf('http://%s/service/api/mailings/cancel',MAILINGS_HOST_PORT));
define('MAILINGS_ACCELERATE_URL',sprintf('http://%s/service/api/mailings/accelerate',MAILINGS_HOST_PORT));
