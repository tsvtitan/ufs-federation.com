...
<?php if(!$page['needChangePassword']) { print_tabbar(); } ?>
    ...
    <!-- by TSV -->
		<div class="field">
			<div class="flabel"><?php echo getlocal('form.field.phone') ?></div>
			<div class="fvalue">
				<input type="text" name="phone" size="40" value="<?php echo form_value('phone') ?>" class="formauth"<?php echo $page['canmodify'] ? "" : " disabled=\"disabled\"" ?>/>
			</div>
			<div class="fdescr"> &mdash; <?php echo getlocal('form.field.phone.description') ?></div>
			<br clear="all"/>
		</div>

		<div class="field">
			<div class="flabel"><?php echo getlocal('form.field.occupation') ?></div>
			<div class="fvalue">
				<input type="text" name="occupation" size="40" value="<?php echo form_value('occupation') ?>" class="formauth"<?php echo $page['canmodify'] ? "" : " disabled=\"disabled\"" ?>/>
			</div>
			<div class="fdescr"> &mdash; <?php echo getlocal('form.field.occupation.description') ?></div>
			<br clear="all"/>
		</div>

		<div class="field">
			<div class="flabel"><?php echo getlocal('form.field.sex') ?></div>
			<div class="fvalue">
        <select name="sex" size="2" class="formauth"<?php echo $page['canmodify'] ? "" : " disabled=\"disabled\"" ?>>
          <option value="0" <?php echo(form_value('sex')=='0'?'selected':''); ?>><?php echo getlocal('form.field.sex.female') ?></option>
          <option value="1" <?php echo(form_value('sex')=='1'?'selected':''); ?>><?php echo getlocal('form.field.sex.male') ?></option>
        </select>
			</div>
			<div class="fdescr"> &mdash; <?php echo getlocal('form.field.sex.description') ?></div>
			<br clear="all"/>
		</div>
