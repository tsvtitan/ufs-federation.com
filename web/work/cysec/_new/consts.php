...
#define ('FANSY_DB','10.1.1.105:E:\Firebird\BASES\SPECTRE_DATA.FDB');
...
define ('CYSEC_DB_USER','cysec');
define ('CYSEC_DB_PASS','qvzuT7az');
...
define ('CYSEC_SFTP_HOST','127.0.0.1');
define ('CYSEC_SFTP_PORT',22);
define ('CYSEC_SFTP_USER','root');
define ('CYSEC_SFTP_PASS','1qsc2wdv3efb');
define ('CYSEC_SFTP_INCOMING','/var/www/cysec/incoming');
define ('CYSEC_SFTP_OUTGOING','/var/www/cysec/outgoing');
...
$REPORT_DATE = date_create('2012-01-01');
//$REPORT_EMAILS = array ('tsv@ufs-federation.com','s.ilioukhina@ufs-federation.com.cy');
