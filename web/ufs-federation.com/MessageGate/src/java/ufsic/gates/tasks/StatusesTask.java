...
public class StatusesTask extends MessageGateTask {

  private String channelId = null;
  
  public StatusesTask(IMessageGate gate, String channelId, boolean withWait) {
    super(gate, withWait);
      ...
      if (isNotNull(p)) {
        ...
        try {
          ...
          if (r) {
            ...
            boolean f = channels.getStatuses(getWithWait());
            result.setSuccess(f);
          }
        } finally {
          p.disconnect();
