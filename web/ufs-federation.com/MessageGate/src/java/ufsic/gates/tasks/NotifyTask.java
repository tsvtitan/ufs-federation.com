...
public class NotifyTask extends MessageGateTask {

  private String channelId = null;
  
  public NotifyTask(IMessageGate gate, String channelId, boolean withWait) {
    super(gate, withWait);
        ...
        try {
          ...
          if (r) {
            ...
            if (mgc instanceof IncomingMessageChannel) {
              ...
              r = run(new IncomingTask(getGate(),channelId,false),false);  

            } else if (mgc instanceof OutgoingMessageChannel) {

              r = run(new OutgoingTask(getGate(),channelId,false),false);  
            }
            result.setSuccess(r);
          }
        } finally {
