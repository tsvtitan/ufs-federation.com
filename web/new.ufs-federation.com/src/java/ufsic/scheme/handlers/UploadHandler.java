...
public class UploadHandler extends Handler {
  ...
  public boolean process(Comm comm) {
    ...
    String fileLocation, fileName, fileExtension, resultStatusText, res;
    byte[] buffer, locationData;
    int len, pos, count, offset = 0, contentLen, resultStatusCode = -1;
    ...
    //response.setHeader("STATUS", resultStatus);
