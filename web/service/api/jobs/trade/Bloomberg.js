      ...
      async.waterfall([
        ...
        function findInstruments(result){
          ...
          var where = {
            ...
            'bloomberg.disabled': [null,undefined,false]
          };
          
          Instruments.find({where:where,sort:{created:-1}},
                           {fields:{id:1,bloomberg:1}},
        ...
        function getTradeValues(instruments,result) {
          ...
          if (instruments && instruments.length>0) {
            ...
            Utils.forEach(instruments,function(instrument){
              ...
              var bloomberg = instrument.bloomberg;
              if (bloomberg && bloomberg.parameters && bloomberg.parameters.length>0) {
                ...
                Utils.forEach(bloomberg.parameters,function(parameter){
            ...
            BloombergExtractor.getTradeValues(arr,function(err,values){
              result(err,values);
            });
