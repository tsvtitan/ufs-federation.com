...
public class CalendarView extends FrameLayout {
    ...
    private ArrayList<Long> listEventDates;
    
    public void setEventDates(ArrayList<Long> listEventDates) {
    ...
    public CalendarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        listEventDates = new ArrayList<Long>();
        listEventDates.add(1392148800L);
        listEventDates.add(1391976000L);
        listEventDates.add(1389816000L);
        listEventDates.add(1388347200L);
    ...
    private class WeekView extends View {
        ...
        public void init(int weekNumber, int selectedWeekDay, int focusedMonth) {
            ...
            eventDay = new boolean[mNumCells];
            ...
            for (; i < mNumCells; i++) {
                ...
                if (mTempDate.before(mMinDate) || mTempDate.after(mMaxDate)) {
                    ...
                    long unixDate = mTempDate.getTimeInMillis() / 1000;
                    eventDay[i] = listEventDates.contains(unixDate);
                }
        ...
        private void initilaizePaints() {
        	...
        	eventPaint.setColor(0xff0969ab);
        	eventPaint.setAntiAlias(true);
        	eventPaint.setStyle(Style.FILL);
        }
        ...
        private void drawWeekNumbersAndDates(Canvas canvas) {
            ...
            if (isLayoutRtl()) {
                ...
                for (; i < nDays; i++) {
                    ...
                    if(eventDay[i])
                    	canvas.drawCircle(x, y+14, 7, eventPaint);
                }
            }
        }
        ...
        private void drawWeekSeparators(Canvas canvas) {
            ...
            int cellWidth = mWidth / mNumCells;
            for (int i = 0; i < mNumCells; i++) {
                canvas.drawLine(cellWidth*i , 0, cellWidth*i, canvas.getHeight(), mDrawPaint);
            }
        }
        ...
        private void drawSelectedDateVerticalBars(Canvas canvas) {
            ...
            mSelectedDateVerticalBar.setBounds(mSelectedLeft + 2 - mSelectedDateVerticalBarWidth / 2,
                    mWeekSeperatorLineWidth - 3,
                    mSelectedRight - 2 + mSelectedDateVerticalBarWidth / 2, mHeight + 3);
