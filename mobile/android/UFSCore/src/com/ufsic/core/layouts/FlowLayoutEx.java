package com.ufsic.core.layouts;
...
public class FlowLayoutEx extends ViewGroup {
	...
	public FlowLayoutEx(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public FlowLayoutEx(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            int index = a.getInt(R.styleable.FlowLayoutEx_android_gravity, -1);
            if(index > 0) {
                setGravity(index);
            }
        } finally {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for(int i = 0; i < childCount; i++) {
            ...
            if(lineWidth + childWidth > sizeWidth || lastChild) {
            	...
            	/* tsv */boolean n = lineWidth + childWidth > sizeWidth;
	...
	public static class LayoutParams extends MarginLayoutParams {
		...
		public LayoutParams(Context c, AttributeSet attrs) {
			...
			TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.FlowLayoutEx_Layout);

            try {
                gravity = a.getInt(R.styleable.FlowLayoutEx_Layout_android_layout_gravity, -1);
            } finally {
                a.recycle();
            }
		}
