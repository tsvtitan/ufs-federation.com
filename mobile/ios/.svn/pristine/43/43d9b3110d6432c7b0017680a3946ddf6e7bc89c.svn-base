...
/* tsv *///static NSString * const kOpenUDIDDescription = @"OpenUDID_with_iOS6_Support";
...
+ (NSString*) md5StringFor:(NSString*)input;
@end
...
+ (NSString*) valueWithError:(NSError **)error {
    ...
    /* tvs */NSString *bundleIdentifier = [[NSBundle mainBundle] bundleIdentifier];
    ...
    if (optedOut) {
        ...
        /* tsv */ kOpenUDIDSessionCache = [OpenUDID md5StringFor:[NSString stringWithFormat:@"%@%@",bundleIdentifier,kOpenUDIDSessionCache]];
        return kOpenUDIDSessionCache;
    }
