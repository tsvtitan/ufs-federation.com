...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(showNotificationCategories) name:kNotificationCategories object:nil];
    ...
    [self.viewController revealToggleAnimated:NO];
...
/* tsv */
-(void)showNotificationCategories
{
    NSUserDefaults *userDef = [NSUserDefaults standardUserDefaults];
    NSTimeInterval interval = 1.000;
    if ([userDef valueForKey:kAuthCategoryDelay]) {
        interval = [[userDef valueForKey:kAuthCategoryDelay] floatValue] / 1000;
    }
    [NSObject cancelPreviousPerformRequestsWithTarget:self selector:@selector(showDefaultCategory) object:nil];
    [self performSelector:@selector(showDefaultCategory) withObject:nil afterDelay:interval];
}
